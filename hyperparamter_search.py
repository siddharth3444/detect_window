...
def model_init(trial=None):
    ...
    if trial:
        params = trial.params
    config = AutoModelForUniversalSegmentation.from_pretrained(args.model_name_or_path)
...
def main():
    ...
    dataset["validation"] = dataset["validate"].with_transform(validation_transform_batch)

    # ------------------------------------------------------------------------------------------------
    # Trainer Hyper Parameter Search Trainer API
    # ------------------------------------------------------------------------------------------------
